...
public class MediaService extends Service {
	...
	CountDownTimer timer = new CountDownTimer(1200, 400) {
	...
	private void updateUI() {// TODO 方法名
		...
		// TODO Auto-generated method stub
		if (isStart == true) {
			if (isFristServier == false) {
				isFristServier = true;
				String artist = mMusicInfo.getArtist();
				final String name = mMusicInfo.getName();
				...
				Intent playIntent = new Intent(
						Constant.BROADCAST_ACTION_NOT_PLAY);
				...
				Intent prevIntent = new Intent(
						Constant.BROADCAST_ACTION_NOT_PREV);
				...
				mRemoteViews.setTextViewText(R.id.notification_item_artist,
						artist);
				...
				Intent stateIntent = new Intent(
						Constant.BROADCAST_ACTION_APP_STATE);
