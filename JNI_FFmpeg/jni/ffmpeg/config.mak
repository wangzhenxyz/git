...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-version3 --enable-gpl --enable-nonfree --disable-stripping --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-encoders --disable-muxers --disable-devices --enable-protocols --enable-protocol=file --enable-avfilter --enable-network --disable-mpegaudio-hp --disable-avdevice --enable-cross-compile --cc=D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-gcc --cross-prefix=D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi- --nm=D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-nm --extra-cflags='-fPIC -DANDROID' --disable-asm --enable-neon --enable-armv5te --extra-ldflags='-Wl,-T,D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/arm-eabi/lib/ldscripts/armelf.x -W1,-rpath-link=D:/lxy/Android/android-ndk-r4/build/platforms/android-8/arch-arm/usr/lib -LD:/lxy/Android/android-ndk-r4/build/platforms/android-8/arch-arm/usr/lib -nostdlib D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtbegin.o D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl'
prefix=/usr/local
...
SRC_PATH="/cygdrive/e/lxy/workSpace/helloFFmpeg/jni/ffmpeg"
SRC_PATH_BARE=/cygdrive/e/lxy/workSpace/helloFFmpeg/jni/ffmpeg
BUILD_ROOT="/cygdrive/e/lxy/workSpace/helloFFmpeg/jni/ffmpeg"
ARCH=c
CC=D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-gcc
AS=D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-gcc
LD=D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-gcc
DEPCC=D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-gcc
YASM=yasm
YASMDEP=yasm
AR=D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-ar
RANLIB=D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/bin/arm-eabi-ranlib
CP=cp -p
LN_S=ln -sf
...
CC_O=-o $@
DLLTOOL=
LDFLAGS=  -Wl,-T,D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/arm-eabi/lib/ldscripts/armelf.x -W1,-rpath-link=D:/lxy/Android/android-ndk-r4/build/platforms/android-8/arch-arm/usr/lib -LD:/lxy/Android/android-ndk-r4/build/platforms/android-8/arch-arm/usr/lib -nostdlib D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtbegin.o D:/lxy/Android/android-ndk-r4/build/prebuilt/windows/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
